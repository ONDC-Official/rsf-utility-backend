...
const UserSchema = new mongoose.Schema(
	{
		...
		current_np_tcs: { type: Number, required: false, set: round2 },
		current_np_tds: { type: Number, required: false, set: round2 },
		current_pr_tcs: { type: Number, required: false, set: round2 },
		current_pr_tds: { type: Number, required: false, set: round2 },
		np_tcs_with_effective_date: { type: Date, required: false, default: null },
		np_tds_with_effective_date: { type: Date, required: false, default: null },
